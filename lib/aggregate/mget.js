...
var mget = function(api, alias, ids, cacheTime, callback){
  ...
  utils.runWithLimitAndCache(api, api.elasticsearch.client.cat, 'aliases', [{
    name: alias
  }], cacheTime, function(error, data){
    ...
    indexes.forEach(function(index){
      jobs.push(function(done){
        ...
        utils.runWithLimitAndCache(api, api.elasticsearch.client, 'mget', [query], cacheTime, next);
      })
    });
